...
@yield('content')
  ...
  <footer class="main-footer text-right">
    <p>Created with <i class="bi bi-suit-heart-fill text-danger"></i> by <a href="https://instagram.com/elitiarad?igshid=YmMyMTA2M2Y=" class="text-white fw-bold">eli </a> & <a href="https://www.instagram.com/yevadollaaa/" class="text-white fw-bold">dolla</a></p>
  </footer>
</div>
<!-- ./wrapper -->
