...
@section('content')
<body>
    <h1 class="text-center mb-5 mt-5">Edit Data Pasien</h1>
                    ...
                    <form action="/updatedata/{{$data->id }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="keluhan" aria-label="With textarea">{{ $data->keluhan }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Riwayat Penyakit</label>
                            <textarea class="form-control" name="riwayatPenyakit" aria-label="With textarea">{{ $data->riwayatPenyakit }}</textarea>
                        </div>
                        <div class="mb-3">
